...
% GA2
    ...
    Weight = [  0.0000    0.0072    0.9999    0.7323
                     0    0.0056   -0.0070    0.5537
                0.0011    0.4978   -0.9998    0.0079
                0.2127    0.3427   -0.8547    0.0003
                0.0181    0.3254   -0.5621    0.0002
                0.0379    0.8975    0.7293    0.1128
                     0    0.1014    0.4753    0.7694
                0.0002    0.0167    0.9988    0.5579
                0.0000    0.0006    0.0034    0.7646
                0.1874    0.5644    0.0392    0.0204];
    ...
    for i = 1 : length(Fit)
        index = type == i;
        Offspring(index) = (Upper(index)-Lower(index)).*r1(index)*Weight(i,1) + ...
